...
function extractTableData() {
    ...
    const tableContainer = document.evaluate(
        '/html/body/app-root/app-preview/div/div/mat-sidenav-container/mat-sidenav-content/div/app-dashboard-designer/div/div[2]/div/ngx-gridster/div/ngx-gridster-item[5]/div/div[2]/app-visualization-grid-wrapper/div/app-visualization-grid-view/div/ag-grid-angular/div/div[2]/div[2]/div[3]/div[2]/div/div',
        document,
        null,
