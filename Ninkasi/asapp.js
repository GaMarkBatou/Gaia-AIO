    ...
    function executeAfterDelay() {
        ...
        if (kozernCustomer == "Asahi Europe Ltd" && ttKlasseA == "Sub") {
            ...
            document.getElementById("asahiPP").addEventListener("click", function() {
                ...
                var urlMailpp = `mailto:support@parkplacetech.com;David-Csaba.Berkes@telekom.com?cc=SIC_SDX_SDWAN@telekom.com&subject=Asahi Europe Ltd || Managed Services ticket request  || wTTS TT: ${encodeURIComponent(ttidTicket)} || Location: ${encodeURIComponent(ppzipLc)} ${encodeURIComponent(ppcityLc)} ${encodeURIComponent(ppstraLc)} || Issue with the following device(s).  &body=Dear Team, %0a Please raise a ticket for us, please see the details:%0a%0a1.	Full company name and end user, if applicable. - Asahi Europe Ltd %0a2.	Full site address (street name and number, city, Postal Code, and any floor, suite, or building number, if applicable).- ${encodeURIComponent(ppzipLc)} ${encodeURIComponent(ppcityLc)} ${encodeURIComponent(ppstraLc)}%0a3.	Are the site address and shipping address the same? If not, please provide shipping address.-Same%0a4.	For your service request, would you prefer an engineer on site, parts only, or remote assistance only? - Depending on the investigation results from your technical team. %0a6.	For service delivery expectations, would you prefer service today or is next business day suitable? (Please include hours of operation.)- As soon as possible %0a7.	Serial number or Service Tag of the device.-%0a8.	Make and model of the equipment.-%0a9.	Short description of issue. (Feel free to add any affected part numbers, images or screenshots in the email) - ${encodeURIComponent(ppwichTung)} %0a10.	What is the impact to your business or customers?-%0a`;
//${encodeURIComponent(ppbesch)}
                window.open(urlMailpp, "_blank");
				
				copyToClipboard (ppzipLc, ppcityLc, ppstraLc, ppnameLc, ppphoneLc, ppmailLc, ppwichTung);
				function copyToClipboard(ppzipLc, ppcityLc, ppstraLc, ppnameLc, ppphoneLc, ppmailLc, ppwichTung) {
				  const text = `Dear Team,

Please raise a ticket for us, please see the details:

1. Full company name and end user, if applicable. - Asahi Europe Ltd
2. Full site address (street name and number, city, Postal Code, and any floor, suite, or building number, if applicable). - ${ppzipLc} ${ppcityLc} ${ppstraLc}
3. Are the site address and shipping address the same? If not, please provide shipping address. - Same
4. For your service request, would you prefer an engineer on site, parts only, or remote assistance only? - Depending on the investigation results from your technical team.
5. For service delivery expectations, would you prefer service today or is next business day suitable? (Please include hours of operation.) - As soon as possible
6. Serial number or Service Tag of the device. -
7. Make and model of the equipment. -
8. Short description of issue. (Feel free to add any affected part numbers, images or screenshots in the email) - 
9. What is the impact to your business or customers? - For the customer, it is ${ppwichTung}

Please revert back to us with your ticket reference and after performing the initial checking at your part. If you need any information from us, for the ticket opening – please do not hesitate to contact us on the below represented availabilities:

• Our team’s hotline number: +49 69 973 179 9108
• Our team’s e-mail address: SIC_SDX_SDWAN@telekom.com
